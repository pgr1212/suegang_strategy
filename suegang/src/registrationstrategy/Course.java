...
public class Course {
    ...
    public String getRecommendReason() {
        switch (getRiskLevel()) {
            case DANGER:
                return "경쟁률이 매우 높으므로 가장 먼저 신청하는 것이 좋습니다.";
            case WARNING:
                return "경쟁률이 높은 편이므로 우선순위를 앞쪽에 두는 것이 좋습니다.";
            case NORMAL:
                return "경쟁률이 보통 수준이므로 중간 순서로 신청해도 괜찮습니다.";
            default:
                return "비교적 여유가 있으므로 뒤쪽 순서로 신청해도 괜찮습니다.";
        }
    }
